...
- Source folders scanned: `/Users/zincdigital/Downloads` (top-level only), archived legacy v8 prescreen repo exports
...
| 3 | V8-PS Legacy | legacy_v8_prescreen_recent_repo.csv | recent_2024plus | 2360 | 5300.00 | 35.42% | 2024-04-02 03:30 -> 2026-04-17 13:45 |
| 4 | V8-PS Legacy | legacy_v8_prescreen_2025fwd_repo.csv | post_break_2025plus | 1511 | 4233.00 | 35.67% | 2025-01-02 10:00 -> 2026-04-17 14:00 |
...
| 7 | V8-PS Legacy | legacy_v8_prescreen_2025fwd_download_a.csv | post_break_2025plus | 1633 | 1562.75 | 34.78% | 2025-01-02 10:00 -> 2026-04-17 15:30 |
...
| Rank | Family | File | Scope | Trades | Net P&L USD | Win Rate | Date Span |
|---|---|---|---|---:|---:|---:|---|
| 1 | V8-PS Legacy | legacy_v8_prescreen_full_repo.csv | full_2020plus | 7925 | -25337.50 | 33.34% | 2020-01-02 08:15 -> 2026-04-17 13:30 |
...
| 5 | V8-PS Legacy | legacy_v8_prescreen_2025fwd_download_c.csv | post_break_2025plus | 2583 | -14666.00 | 33.29% | 2025-01-02 09:30 -> 2026-04-17 15:30 |
...
## V8-PS Legacy Canonical Runs

| File | Scope | Trades | Net P&L USD | Win Rate | Avg Trade USD | Date Span | Source |
|---|---|---:|---:|---:|---:|---|---|
| legacy_v8_prescreen_recent_repo.csv | recent_2024plus | 2360 | 5300.00 | 35.42% | 2.25 | 2024-04-02 03:30 -> 2026-04-17 13:45 | repo |
| legacy_v8_prescreen_2025fwd_repo.csv | post_break_2025plus | 1511 | 4233.00 | 35.67% | 2.80 | 2025-01-02 10:00 -> 2026-04-17 14:00 | repo |
| legacy_v8_prescreen_2025fwd_download_a.csv | post_break_2025plus | 1633 | 1562.75 | 34.78% | 0.96 | 2025-01-02 10:00 -> 2026-04-17 15:30 | downloads |
| legacy_v8_prescreen_2025fwd_download_b.csv | post_break_2025plus | 1939 | -5709.25 | 33.83% | -2.94 | 2025-01-02 10:00 -> 2026-04-17 15:15 | downloads |
| legacy_v8_prescreen_2025fwd_download_c.csv | post_break_2025plus | 2583 | -14666.00 | 33.29% | -5.68 | 2025-01-02 09:30 -> 2026-04-17 15:30 | downloads |
| legacy_v8_prescreen_full_repo.csv | full_2020plus | 7925 | -25337.50 | 33.34% | -3.20 | 2020-01-02 08:15 -> 2026-04-17 13:30 | repo |
...
- Canonical: `legacy_v8_prescreen_2025fwd_repo.csv` (repo)
  - Duplicate: `legacy_v8_prescreen_2025fwd_download_d.csv` (downloads)
- Canonical: `legacy_v8_prescreen_full_repo.csv` (repo)
  - Duplicate: `legacy_v8_prescreen_full_download.csv` (downloads)
- Canonical: `legacy_v8_prescreen_recent_repo.csv` (repo)
  - Duplicate: `legacy_v8_prescreen_recent_download.csv` (downloads)
...
- Neutral aliases are used above for the retired legacy prescreen exports so the markdown note stays lane-agnostic; the raw file ledger remains in the companion CSV artifact.
