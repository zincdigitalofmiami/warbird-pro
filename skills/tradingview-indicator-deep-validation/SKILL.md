---
name: tradingview-indicator-deep-validation
description: Checkpointed TradingView Pine indicator build, deep quant validation, logic review, and improvement recommendations tied to project data contracts and platform limits. Use when working on indicator or strategy Pine files, no-repaint checks, alert behavior, deep-testing plans, or release-readiness reviews that must stay aligned with the repository's current active plan.
---

# TradingView Indicator Deep Validation
