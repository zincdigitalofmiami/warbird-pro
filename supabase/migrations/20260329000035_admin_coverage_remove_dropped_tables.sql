-- Migration 035: remove dropped legacy tables from admin coverage RPC.
...
comment on function public.get_admin_table_coverage() is
  'Authenticated admin coverage helper aligned to the post-migration-028 schema and tolerant of missing retired tables.';
