...
// Ported from app/api/cron/mes-hourly/route.ts
...
import { aggregateMes4hFrom1h, aggregateMes1dFrom1h, type OhlcvBar } from "../_shared/mes-aggregation.ts";
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (!mes1mData || mes1mData.length === 0) {
      ...
      return jsonResponse({ success: true, reason: "no_1m_data", duration_ms: Date.now() - startMs });
    }
